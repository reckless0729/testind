...
function addModuleHovers() {
    ...
    CENTER_AREA.insertAdjacentHTML('beforeend', '<a style="font-size:12px;position:absolute;top:380px;left:55px;display:none;width:130px;" class="smallFancyButton" id="conminema"></a>');
    hoverminemachine = l('conminema');
    hoverminemachine.innerHTML = '全自動採掘機　　　　　　　　　　秒間100万Eを消費して鉱石を採掘する';
}
