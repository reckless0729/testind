...
export function addEvents() {
    ...
    AddEvent(buttonminemachine, 'click', onminemachineButtonClick);
    ...
    AddEvent(buttonminemachine, 'mouseover', function () {
        hoverminemachine.style.display = 'block'
    });
    AddEvent(buttonminemachine, 'mouseleave', function () {
        hoverminemachine.style.display = 'none'
    });
}
...
function onStartClickerButtonClick() {
    ...
    if (MOD.buttonClicks % 2 === 0) {
        ...
        buttonminemachine.style.display = "none";
    }
}
...
function onModulesButtonClick() {
    ...
    buttonminemachine.style.display = "block";
}
...
function onminemachineButtonClick() {
    if (MOD.eps<1000000){
        return
    }
    PlaySound('snd/pop'+Math.floor(Math.random()*3+1)+'.mp3',0.5);//play the sound pop1, pop2 or pop3 at random with half-volume
